...
const projects = [
  ...
  { slug: 'shadow-puppet', id: '03', title: '光影千年 / SHADOW PUPPET', type: '非遗文化 · 皮影 IP 形象设计', image: '/assets/shadow/cover.png', year: '2026' },
  { slug: 'beihai-animation', id: '04', title: '潮起疍风华 / A DAN', type: '科普动画 · 疍家文化 IP', image: '/assets/beihai/cover-clear.png', year: '2026' },
  { slug: 'tea-life', id: '05', title: '一片茶，见一生 / A LEAF OF TEA', type: 'AIGC 动画 · 瑶族油茶非遗', image: '/assets/chajian/cover-wide.jpg', year: '2026' },
  { slug: 'small-ranch', id: '06', title: '小小牧场 / SMALL RANCH', type: 'Unity 2D · 像素经营游戏', image: '/assets/farm/cover.png', year: '2026' },
]
...
function CoffeeProject({ project, navigate }) {
  return <main className="coffee-project">
    ...
    <section className="coffee-page coffee-cover">
      <img src="/assets/coffee/cup.png" alt="整点咖啡品牌咖啡杯实物展示" />
...
function BaizeProject({ project, navigate }) {
  return <main className="baize-project">
    ...
    <section className="baize-page baize-cover">
      <img className="baize-cover-art" src="/assets/baize/cover-complete.png" alt="白泽祥瑞神兽IP形象设计封面" />
    ...
    <section className="baize-page baize-profile-page">
      ...
      <div className="shell baize-identity-grid">
        <BaizeArtwork src="/assets/baize/identity-card.png" alt="白泽神兽身份设定：籍贯、身份、性格与爱好" />
        <BaizeArtwork src="/assets/baize/design-concept.png" alt="白泽IP设计理念与色彩搭配" />
      </div>
    </section>
    ...
    <section className="baize-page baize-views-page">
      ...
      <BaizeArtwork src="/assets/baize/turnaround.png" className="shell baize-wide-art" alt="白泽IP形象正面、侧面和背面三视图" />
    </section>
    ...
    <section className="baize-page baize-expression-page">
      ...
      <BaizeArtwork src="/assets/baize/expressions.png" className="shell baize-wide-art" alt="白泽开心、惊喜、期待、错愕和委屈等八种完整表情" />
    </section>
    ...
    <section className="baize-page baize-costume-page">
      ...
      <BaizeArtwork src="/assets/baize/costumes-actions.png" className="shell baize-portrait-art" alt="白泽财神、武将、书生服装及动作延展" />
    </section>
    ...
    <section className="baize-page baize-merch-page">
      ...
      <BaizeArtwork src="/assets/baize/merchandise.png" className="shell baize-wide-art" alt="白泽徽章、钥匙扣和磁贴文创周边" />
    </section>
    ...
    <section className="baize-page baize-package-page">
      ...
      <BaizeArtwork src="/assets/baize/blindbox.png" className="shell baize-wide-art" alt="白泽财神、武将和书生系列盲盒包装设计" />
    </section>
    ...
    <section className="baize-page baize-scene-page">
      ...
      <BaizeArtwork src="/assets/baize/campaign-scenes.png" className="shell baize-wide-art baize-scene-art" alt="白泽IP地铁与公共空间宣传海报应用" />
    </section>
    <ProjectFooter current={project} navigate={navigate} />
  </main>
}
...
function ShadowProject({ project, navigate }) {
  return <main className="shadow-project">
    ...
    <section className="shadow-page shadow-cover">
      <img className="shadow-cover-art" src="/assets/shadow/cover.png" alt="光影千年皮影戏IP形象设计封面" />
    ...
    <section className="shadow-page shadow-character-page">
      ...
      <div className="shell shadow-character-grid">
        <BaizeArtwork src="/assets/shadow/character-card.png" alt="影虎角色介绍与完整正面形象" />
        <BaizeArtwork src="/assets/shadow/turnaround.png" alt="影虎正面侧面背面三视图" />
      </div>
    </section>
    ...
    <section className="shadow-page shadow-expression-page">
      ...
      <BaizeArtwork src="/assets/shadow/expressions.png" className="shell shadow-wide-art" alt="影虎十二种完整表情设计" />
    </section>
    ...
    <section className="shadow-page shadow-costume-page">
      ...
      <BaizeArtwork src="/assets/shadow/costumes.png" className="shell shadow-wide-art" alt="影虎骑瑞兽、武将、靠旗和骑马造型" />
    </section>
    ...
    <section className="shadow-page shadow-poster-page">
      ...
      <div className="shell shadow-poster-grid">
        <figure><img src="/assets/shadow/poster-rider.jpg" alt="光影千年骑马角色海报" loading="lazy" /><figcaption>骑马 / RIDER</figcaption></figure>
        <figure><img src="/assets/shadow/poster-warrior.jpg" alt="光影千年武将角色海报" loading="lazy" /><figcaption>武将 / WARRIOR</figcaption></figure>
        <figure><img src="/assets/shadow/poster-qilin.jpg" alt="光影千年麒麟角色海报" loading="lazy" /><figcaption>麒麟 / QILIN</figcaption></figure>
      </div>
    </section>
    ...
    <section className="shadow-page shadow-products-page">
      ...
      <BaizeArtwork src="/assets/shadow/products.png" className="shell shadow-wide-art" alt="影虎钥匙扣、徽章和手机壳应用" />
    </section>
    ...
    <section className="shadow-page shadow-lifestyle-page">
      ...
      <BaizeArtwork src="/assets/shadow/lifestyle.png" className="shell shadow-wide-art" alt="光影千年服装、明信片、帆布袋、抱枕、墙面和折扇应用" />
    </section>
    <ProjectFooter current={project} navigate={navigate} />
  </main>
}
...
function BeihaiProject({ project, navigate }) {
  return <main className="beihai-project">
    ...
    <section className="beihai-page beihai-cover">
      <img className="beihai-cover-art" src="/assets/beihai/cover-clear.png" alt="潮起疍风华广西北海疍家科普动画IP封面" />
    ...
    <section className="beihai-page beihai-film-page">
      ...
      <div className="shell beihai-player-frame">
        <video controls playsInline preload="none" poster="/assets/beihai/cover-clear.png" aria-label="潮起疍风华动画正片">
    ...
    <section className="beihai-page beihai-character-page">
      ...
      <div className="shell beihai-character-modules"><BaizeArtwork src="/assets/beihai/identity-v2.png" className="beihai-module-art" alt="阿疍角色形象、文化记忆点与基础档案" /><BaizeArtwork src="/assets/beihai/views-v2.png" className="beihai-module-art" alt="阿疍完整正视、四分之三侧视和侧视图" /></div>
    </section>
    ...
    <section className="beihai-page beihai-poster-page">
      ...
      <BaizeArtwork src="/assets/beihai/posters-v2.png" className="shell beihai-module-art beihai-poster-art" alt="追风遇海、贝珠手作、海边温情、航行无际四张完整主题海报" />
    </section>
    ...
    <section className="beihai-page beihai-mockup-page">
      ...
      <figure className="shell beihai-mockup"><img src="/assets/beihai/physical-mockup.png" alt="阿疍亚克力立牌、帆布袋、明信片和徽章实物应用效果" loading="lazy" /><figcaption><span>GENERATED APPLICATION VISUAL</span><span>亚克力立牌 · 帆布袋 · 明信片 · 徽章</span></figcaption></figure>
    </section>
    <ProjectFooter current={project} navigate={navigate} />
  </main>
}
...
function TeaLifeProject({ project, navigate }) {
  ...
  return <main className="tea-project">
    ...
    <section className="tea-page tea-cover">
      <img className="tea-cover-art" src="/assets/chajian/cover-wide.jpg" alt="一片茶见一生瑶族油茶非遗动画封面" />
    ...
    <section className="tea-page tea-film-page">
      ...
      <div className="shell tea-player"><video controls playsInline preload="none" poster="/assets/chajian/cover-source.png" aria-label="一片茶见一生动画正片"><source src="/assets/chajian/animation.mp4" type="video/mp4" />当前浏览器不支持视频播放。</video><div><span>FULL FILM</span><span>点击播放 · 支持全屏观看</span></div></div>
    </section>
    ...
    <section className="tea-page tea-character-page">
      ...
      <div className="shell tea-character-grid tea-character-grid--complete"><figure><img src="/assets/chajian/character-panel-grandmother.png" alt="外婆毛毡人物正面侧面背面完整三视图" loading="lazy" /><figcaption><span>01 · 外婆 / GRANDMOTHER</span><small>情感引路人 · 传统生活的守护者</small></figcaption></figure><figure><img src="/assets/chajian/character-panel-child.png" alt="年少阿茶毛毡人物正面侧面背面完整三视图" loading="lazy" /><figcaption><span>02 · 年少阿茶 / YOUNG ACHA</span><small>故事起点 · 初识油茶与家族记忆</small></figcaption></figure><figure><img src="/assets/chajian/character-panel-teen.png" alt="青年阿茶第一套民族服饰完整三视图" loading="lazy" /><figcaption><span>03 · 青年阿茶 / ACHA</span><small>成长阶段 · 瑶族盛装造型</small></figcaption></figure><figure><img src="/assets/chajian/character-panel-adult.png" alt="成年阿茶民族服饰完整三视图" loading="lazy" /><figcaption><span>04 · 成年阿茶 / ADULT ACHA</span><small>理解传承 · 接过外婆的木槌</small></figcaption></figure><figure><img src="/assets/chajian/character-panel-ahe.png" alt="阿禾毛毡人物正面侧面背面完整三视图" loading="lazy" /><figcaption><span>05 · 阿禾 / A HE</span><small>下一代 · 传承故事的新起点</small></figcaption></figure><figure><img src="/assets/chajian/character-panel-festival.png" alt="瑶族毛毡风格盛装人物完整三视图" loading="lazy" /><figcaption><span>06 · 瑶族盛装 / FESTIVAL LOOK</span><small>服饰细节 · 银饰与织绣纹样</small></figcaption></figure></div>
    </section>
    ...
    <section className="tea-page tea-poster-page" id="tea-posters">
      ...
      <div className="shell tea-poster-grid">
        <figure><div className="tea-poster-mat"><img src="/assets/chajian/poster-01.png" alt="一片茶见一生主题叙事海报" loading="lazy" /></div><figcaption><span>01</span><strong>一生传承 / A LIFETIME OF HERITAGE</strong></figcaption></figure>
        <figure><div className="tea-poster-mat"><img src="/assets/chajian/poster-02.png" alt="一片茶见一生祖孙油茶主题海报" loading="lazy" /></div><figcaption><span>02</span><strong>代代相传 / PASSED THROUGH GENERATIONS</strong></figcaption></figure>
        <figure><div className="tea-poster-mat"><img src="/assets/chajian/poster-03.png" alt="一片茶见一生非遗文化长卷海报" loading="lazy" /></div><figcaption><span>03</span><strong>见人间烟火 / WITNESS A LIFETIME</strong></figcaption></figure>
      </div>
    </section>
    ...
    <section className="tea-page tea-storyboard-page">
      ...
      <div className="shell tea-storyboard-grid">{storyboardCaptions.map((caption, index) => <figure key={caption}><img src={`/assets/chajian/storyboard-v2-${String(index + 1).padStart(2, '0')}.jpg`} alt={`${caption}动画分镜`} loading="lazy" /><figcaption><span>{String(index + 1).padStart(2, '0')}</span><strong>{caption}</strong></figcaption></figure>)}</div>
    </section>
    <ProjectFooter current={project} navigate={navigate} />
  </main>
}
...
function SmallRanchProject({ project, navigate }) {
  ...
  return <main className="farm-project">
    ...
    <section className="farm-page farm-cover">
      <img className="farm-cover-art" src="/assets/farm/cover.png" alt="小小牧场像素游戏封面" />
    ...
    <section className="farm-page farm-loop-page">
      ...
      <figure className="shell farm-wide-art"><img src="/assets/farm/economy-loop.png" alt="小小牧场动物成长、产出与价格体系" loading="lazy" /><figcaption>动物成长阶段 · 资源产出 · 经营反馈</figcaption></figure>
    </section>
    ...
    <section className="farm-page farm-sprite-page">
      ...
      <figure className="shell farm-wide-art farm-wide-art--dark"><img src="/assets/farm/animal-sprites.png" alt="鸡、猪、鸭、兔与奶牛的待机和行走动画序列" loading="lazy" /><figcaption>待机动画 · 行走动画 · 多动物状态</figcaption></figure>
    </section>
    ...
    <section className="farm-page farm-making-page">
      ...
      <div className="shell farm-process-grid"><ProcessCard src="/assets/farm/process-01.png" label="01 / 像素素材绘制" alt="Aseprite 中绘制奶牛像素动画" wide /><ProcessCard src="/assets/farm/process-02.png" label="02 / 场景搭建" alt="Unity 2D 牧场场景搭建" /><ProcessCard src="/assets/farm/process-03.png" label="03 / 动画状态" alt="Unity Animator 动画状态制作" /></div>
    </section>
    ...
    <section className="farm-page farm-system-page">
      ...
      <div className="shell farm-process-grid farm-process-grid--three"><ProcessCard src="/assets/farm/process-04.png" label="01 / 动物行为逻辑" alt="动物行为脚本编写" /><ProcessCard src="/assets/farm/process-06.png" label="02 / 商店界面" alt="游戏商店界面设计" /><ProcessCard src="/assets/farm/process-07.png" label="03 / UI 功能编码" alt="游戏主界面功能编码" /></div>
    </section>
    ...
    <section className="farm-page farm-finale-page">
      ...
      <div className="shell farm-test-gallery">
        <figure><div className="farm-test-image"><img src="/assets/farm/process-05.png" alt="小小牧场 Unity 数据与构建测试画面" loading="lazy" /></div><figcaption><span>01 / BUILD TEST</span><strong>数据与构建测试</strong><small>Unity 构建完成 · 桌面程序运行验证</small></figcaption></figure>
        <figure><div className="farm-test-image"><img src="/assets/farm/process-08.png" alt="小小牧场桌面常驻最终测试画面" loading="lazy" /></div><figcaption><span>02 / FINAL EXPERIENCE</span><strong>最终游戏画面</strong><small>桌面常驻体验 · 实际使用场景测试</small></figcaption></figure>
      </div>
    </section>
    <ProjectFooter current={project} navigate={navigate} />
  </main>
